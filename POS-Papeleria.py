...
#==============================Informacion predeterminada del tickey===============================
def intro(self):
...
def billarea(self):
    ...
    if self.Paqtinta.get() != 0:
        self.txtarea.insert(
            END, f"Paqu.Tinta\t\t {self.Paqtinta.get()}\t{self.ma}\n")
    if self.Paqgeo.get() != 0:
        self.txtarea.insert(
            END, f"Jueg.Geo\t\t {self.Paqgeo.get()}\t{self.sa}\n")
...
#======================================Borra los registros de la venta anterior=========================================
def clear(self):
    self.txtarea.delete(1.0, END)
    self.Lapiz.set(0)
    self.Goma.set(0)
