...
def ventana_inicio():
    ...
    ventana_principal.geometry("1020x640")#DIMENSIONES DE LA VENTANA
    ventana_principal.title("Acceder")#TITULO DE LA VENTANA
    Label(text="PAPELERIA DON QUIJOTE", bg="LightBlue", width="300", height="2", font=("Calibri", 13)).pack()#ETIQUETA CON TEXTO
    Label(text="").pack()
...
def registro():
    ...
    ventana_registro.geometry("1020x640")
...
def login():
    ...
    ventana_login.geometry("1020x640")
